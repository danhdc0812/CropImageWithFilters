package com.androideve.cropimagewithfilters.utils;
...
/**
 * Created by bytesbrick on 31/1/17.
 */
...
public class ImageFilters {
    ...
    public  static Bitmap applySepiaToningEffect(Bitmap src, int depth, double red, double green, double blue) {
        // image size
        int width = src.getWidth();
        int height = src.getHeight();
        // create output bitmap
    ...
    public static Bitmap applyWaterMarkEffect(Bitmap src, String watermark, int x,int y, int color, int alpha, int size, boolean underline) {
        int w = src.getWidth();
        int h = src.getHeight();
